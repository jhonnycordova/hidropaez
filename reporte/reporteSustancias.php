  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-filter"></span><a href="../formato/formatoSustancias.php" > Fto. Sustancias Químicas</a>
                                    </td>
                                </tr>
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                 <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-sort-by-attributes"></span><a href="reporteGuardia.php"> Reporte Fto. Diario</a>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-sort-by-attributes-alt"></span><a href="reporteParametros.php"> Rpte. Parámetros Fisicoquímicos</a>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-indent-left"></span><a href="reporteSustancias.php"> Rpte. Sustancias Químicas</a>
                                    </td>
                                </tr>
                                   <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-floppy-save"></span><a href="reporteFinal.php"> Reporte Final</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="reporteSustancias2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Reporte de Sustancias Químicas</div></legend>
                      <br>
                      <div class="form-group" >
                        ...
                        <div class="col-sm-3">
                            <button type="submit" class="btn btn-danger ladda-button" data-style="expand-right">Generar Reporte PDF</button>
                        </div>
