  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-floppy-save"></span><a href="#"> Reporte Final</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="reporteFinal2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Reporte Final</div></legend>
                      <br>
