  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well" >
            <form class="form-horizontal" role="form" id="formulario" action="sistemas2.php" method="post">
                    <fieldset>
                      ...
                      <legend><div class="titulo-form">Sistemas de Potabilización del Estado Guárico</div></legend>
                        ...
                        <div class="col-sm-1">
                            <button type="submit" class="btn btn-primary btn-sm">Consultar Almacén</button>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="1" placeholder="0" class="form-control" name="htacum" id="htacum" value="<?php echo $row2[htacum]; ?>" readonly>
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Sulfato de Aluminio (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="sulaluminio" id="sulaluminio" value="<?php echo $row2[sulaluminio]; ?>" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="gascloro" id="gascloro" value="<?php echo $row2[gascloro]; ?>" readonly>
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cal (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="cal" id="cal" value="<?php echo $row2[cal]; ?>" readonly>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="clresidual" id="clresidual" value="<?php echo $row2[clresidual]; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="1" placeholder="0" class="form-control" name="cilindros_llenos" id="cilindros_llenos" value="<?php echo $row2[cilindros_llenos]; ?>" readonly>
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cilindros Vacíos:</label>
                        <div class="col-sm-3">
                          <input type="number"  step="1" placeholder="0" class="form-control" name="cilindros_vacios" id="cilindros_vacios" value="<?php echo $row2[cilindros_vacios]; ?>" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-5">
                          <div class="pull-right">
                            <?php echo "<a href='../sistemas/modificarSistema.php?sistema=$sistema' class='btn btn-danger'>Modificar</a>" ?>
                            <a href="../formato/home.php" class="btn btn-default">Regresar</a>
