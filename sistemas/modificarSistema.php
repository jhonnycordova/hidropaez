  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Sistemas</a></li>
    ...
    <!-- Button trigger modal -->
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well" >
            <form class="form-horizontal" role="form" id="formulario" action="modificarSistema2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Sistemas de Potabilización del Estado Guárico</div></legend>
                        ...
                        <div class="col-sm-5">
                            <select style="width:100%" name="sistema" id="sistema" readonly>
                       ...
                       <div class="titulo1-form"><b>Almacén:</b></div>


                      <div class="form-group">
                          <label class="col-sm-3 control-label" for="textinput">Ht Acum:</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0" class="form-control" name="htacum" id="htacum" value="<?php echo $row2[htacum]; ?>" >
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Sulfato de Aluminio (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="sulaluminio" id="sulaluminio" value="<?php echo $row2[sulaluminio]; ?>" >
                        </div>
                      </div>


                      <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">Gas Cloro (2000lb)(Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="gascloro" id="gascloro" value="<?php echo $row2[gascloro]; ?>" >
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cal (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="cal" id="cal" value="<?php echo $row2[cal]; ?>" >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="hipoclorito" id="hipoclorito" value="<?php echo $row2[hipoclorito]; ?>" >
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cl Residual (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="clresidual" id="clresidual" value="<?php echo $row2[clresidual]; ?>" >
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="policloruro" id="policloruro" value="<?php echo $row2[policloruro]; ?>" >
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Gas Cloro (150lb)(Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="gasclorolb" id="gasclorolb" value="<?php echo $row2[gasclorolb]; ?>" >
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">Cilindros Llenos:</label>
                        <div class="col-sm-3">
                          <input type="number"  step="1" placeholder="0" class="form-control" name="cilindros_llenos" id="cilindros_llenos" value="<?php echo $row2[cilindros_llenos]; ?>" >
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cilindros Vacíos:</label>
                        <div class="col-sm-3">
                          <input type="number"  step="1" placeholder="0" class="form-control" name="cilindros_vacios" id="cilindros_vacios" value="<?php echo $row2[cilindros_vacios]; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-5">
                          <div class="pull-right">
                            <button type="submit" class="btn btn-danger">Registrar Cambios</button>
                            <a href="sistemas2.php" class="btn btn-default">Regresar</a>
