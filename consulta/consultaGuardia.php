  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="consultaGuardia2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Consulta Diaria</div></legend>
                      <br>
                      <div class="form-group" >
                       ...
                       <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                          <input type="text" placeholder="" class="form-control" value="<?php echo date("d/m/Y");?>" name="fecha" id="fecha" rel="fecha" >
                        </div>
                        <div class="col-sm-3">
