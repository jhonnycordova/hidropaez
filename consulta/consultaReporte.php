  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
                        ...
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-tasks"></span><a href="#"> Reporte Final</a> 
                                    </td>
                                </tr>
                              <tr>
                                    <td>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="consultaReporte2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Consulta del Reporte Final</div></legend>
                      <br>
