  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                 <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-align-justify"></span><a href="consultaGuardia.php"> Consulta Diaria</a> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-zoom-in"></span><a href="#"> Cta. Sustancias Químicas</a> 
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="consultaSustancias2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Consulta del Fto. de Sustancias Químicas</div></legend>
                      <br>
