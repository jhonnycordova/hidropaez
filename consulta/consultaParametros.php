  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="consultaParametros2.php" method="post">
                    <fieldset>

                      <!-- Nombre del Formulario -->
                      <legend><div class="titulo-form">Consulta de Parámetros Fisicoquímicos</div></legend>
                      <br>
