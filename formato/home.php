  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="formato.php">Llenar Formato</a></li>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well" >
               ...
               <div class="row destacados">
                  <div class="col-md-3">
                      <div>
                      <img src="../img/formatoGuardia.jpg" alt="Texto Alternativo" class="img-circle img-thumbnail" width="60%">
                      <h3>Formato <br>Diario</h3>
                      <br><br>
                      <p><br>Formato Diario de Coordinación de Calidad.</p>
                      <br>
                      <a href="formato.php" class="btn btn-danger" title="Enlace">Ir al Formato »</a>
                    </div>
                  </div>

                   <div class="col-md-3">
                      <div>
                      <img src="../img/formatoParametros.jpg" alt="Texto Alternativo" class="img-circle img-thumbnail" width="60%">
                      <h3>Fto. Parámetros Fisicoquímicos</h3>
                      <p>Formato Diario de los Parámetros Fisicoquímicos de los Diferentes Sistemas de Potabilización del Estado Guárico.</p>
                      <a href="formatoParametro.php" class="btn btn-danger" title="Enlace">Ir al Formato »</a>
                    </div>
                  </div>

                   <div class="col-md-3">
                      <div>
                      <img src="../img/sustancias.jpg" alt="Texto Alternativo" class="img-circle img-thumbnail" width="60%">
                      <h3>Fto. Sustancias Químicas</h3>
                      <br>
                      <p>Formato Diario del Consumo de Sustancias Químicas en los Diferentes Sistemas de Potabilización del Estado Guárico.</p>
                      <a href="sustancias.php" class="btn btn-danger" title="Enlace">Ir al Formato »</a>
                    </div>
                  </div>

                    <div class="col-md-3">
                      <div>
                      <img src="../img/reporte.jpg" alt="Texto Alternativo" class="img-circle img-thumbnail" width="60%">
                      <h3>Reporte Final</h3>
                      <br>
                      <p><br><br>Reporte para la Gerencia General Técnica.</p><br><br>
                      <a href="../consulta/consultaReporte.php" class="btn btn-danger" title="Enlace">Ir al Formato »</a>
                    </div>
                  </div>
