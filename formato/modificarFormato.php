  ...
  <div class="container-fluid">
    ...
    <!-- Button trigger modal -->
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <form class="form-horizontal" role="form" id="formulario" action="modificarFormato2.php" method="post">
                    <fieldset>
                      ...
                      <div class="form-group" id="panel1">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="ht" id="ht" value="<?php echo $row2[ht]; ?>" >
                          
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Sulfato de Al Consumido (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="sulconsumido" id="sulconsumido" value="<?php echo $row2[sulconsumido]; ?>" >
                      ...
                      <div class="form-group" id="panel2">
                        ...
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="gasconsumido" id="gasconsumido" value="<?php echo $row2[gasconsumido]; ?>" >
                          
                        </div>
                        <label class="col-sm-3 control-label" for="textinput">Cal Consumida (Kg):</label>
                        <div class="col-sm-3">
                          <input type="number"  step="0.01" placeholder="0.00" class="form-control" name="calconsumido" id="calconsumido" value="<?php echo $row2[calconsumido]; ?>" >
                      ...
                      <div class="form-group" id="panel3">
                        ...
                        <div class="col-sm-3">
                         ...
                         <label class="col-sm-3 control-label" style="margin-top:-20px;" for="textinput"><br>Falla:</label>
                            <div class="col-sm-3">
                              <input type="number"  step="0.01" placeholder="Eléctrica" class="form-control" name="fallaelectrica" id="fallaelectrica" value="<?php echo $row2[fallaelectrica]; ?>">
                              <input type="number"  step="0.01" placeholder="Mecánica" class="form-control" name="fallamecanica" id="fallamecanica" value="<?php echo $row2[fallamecanica]; ?>">
                            </div>
                        ...
                        <div class="titulo1-form" id="titulo"><b>Producción (m<sup>3</sup>)</b></div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-3" id="panel5">
                             <input type="number"  step="0.01" placeholder="Cruda" class="form-control" name="procruda" id="procruda" value="<?php echo $row2[procruda]; ?>" >
                              
                            </div>

                           
                            <div class="col-sm-3" id="panel6">
                              <input type="number"  step="0.01" placeholder="C. acum." class="form-control" name="procacum" id="procacum" value="<?php echo $row2[procacum]; ?>" >
                              
                            </div>

                            <div class="col-sm-3" id="panel7">
                              <input type="number"  step="0.01" placeholder="Potabilizada" class="form-control" name="propota" id="propota" value="<?php echo $row2[propota]; ?>" >
                              
                            </div>
                            <div class="col-sm-3" id="panel8">
                              <input type="number"  step="0.01" placeholder="P. acum." class="form-control" name="propacum" id="propacum" value="<?php echo $row2[propacum]; ?>" >
                        ...
                        <div class="titulo1-form" id="titulo2"><b>Observaciones</b></div>
                         <div class="form-group" id="panel9">
                            ...
                            <textarea class="form-control" rows="3" name="observaciones" id="observaciones" ><?php echo $row2["observaciones"]; ?></textarea>
                        </div>
                      <div class="form-group">
