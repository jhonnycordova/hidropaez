    ...
    if ($noReporto=='No Reportó') {
	    ...
	    if (empty($phfiltradaSanJuan)) {
    		$phfiltradaSanJuan = 0;
	    		...
	    		$sqlSanJuan = ("INSERT INTO sanjuan_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSanJuan', '$turcrudaSanJuan', '$turfiltradaSanJuan', '$colorcrudaSanJuan', '$colorfiltradaSanJuan', '$phcrudaSanJuan', '$phfiltradaSanJuan', true)");

				if(pg_query($sqlSanJuan)){
					$contadorReportaron++;
				}else{

					echo "<script>alert('San Juan No Registrado!') </script>";
    		...
    		$sqlSanJuan = ("INSERT INTO sanjuan_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSanJuan)){
    ...
    if ($noReporto2=='No Reportó') {
	    ...
	    if (empty($phfiltradaCalabozo)) {
    		$phfiltradaCalabozo = 0;
	   			...
	   			$sqlCalabozo = ("INSERT INTO calabozo_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroCalabozo', '$turcrudaCalabozo', '$turfiltradaCalabozo', '$colorcrudaCalabozo', '$colorfiltradaCalabozo', '$phcrudaCalabozo', '$phfiltradaCalabozo', true)");

				if(pg_query($sqlCalabozo)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Calabozo!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlCalabozo = ("INSERT INTO calabozo_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlCalabozo)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto3=='No Reportó') {
	    ...
	    if (empty($phfiltradaAltagracia)) {
    		$phfiltradaAltagracia = 0;
	   			...
	   			$sqlAltagracia = ("INSERT INTO altagracia_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroAltagracia', '$turcrudaAltagracia', '$turfiltradaAltagracia', '$colorcrudaAltagracia', '$colorfiltradaAltagracia', '$phcrudaAltagracia', '$phfiltradaAltagracia', true)");

				if(pg_query($sqlAltagracia)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Altagracia!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlAltagracia = ("INSERT INTO altagracia_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlAltagracia)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto4=='No Reportó') {
	    ...
	    if (empty($phfiltradaVallePascua)) {
    		$phfiltradaVallePascua = 0;
	   			 ...
	   			 $sqlValle = ("INSERT INTO valle_pascua_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroVallePascua', '$turcrudaVallePascua', '$turfiltradaVallePascua', '$colorcrudaVallePascua', '$colorfiltradaVallePascua', '$phcrudaVallePascua', '$phfiltradaVallePascua', true)");

				if(pg_query($sqlValle)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Valle de la Pascua!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlValle = ("INSERT INTO valle_pascua_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlValle)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto5=='No Reportó') {
	    ...
	    if (empty($phfiltradaTucupido)) {
    		$phfiltradaTucupido = 0;
	   			...
	   			$sqlTupido = ("INSERT INTO tucupido_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroTucupido', '$turcrudaTucupido', '$turfiltradaTucupido', '$colorcrudaTucupido', '$colorfiltradaTucupido', '$phcrudaTucupido', '$phfiltradaTucupido', true)");

				if(pg_query($sqlTupido)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Tupido!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlTupido = ("INSERT INTO tucupido_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlTupido)){
					$contadorNoReportaron++;
				}else{
					echo "<script>alert('Error Tupido!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
    }
    ...
    if ($noReporto6=='No Reportó') {
	    ...
	    if (empty($phfiltradaSanJose)) {
    		$phfiltradaSanJose = 0;
    			...
    			$sqlSanJose = ("INSERT INTO san_jose_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSanJose', '$turcrudaSanJose', '$turfiltradaSanJose', '$colorcrudaSanJose', '$colorfiltradaSanJose', '$phcrudaSanJose', '$phfiltradaSanJose', true)");

				if(pg_query($sqlSanJose)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro San Jose!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
    		...
    		$sqlSanJose = ("INSERT INTO san_jose_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSanJose)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto7=='No Reportó') {
	    ...
	    if (empty($phfiltradaZaraza)) {
    		$phfiltradaZaraza = 0;
    			...
    			$sqlZaraza = ("INSERT INTO zaraza_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroZaraza', '$turcrudaZaraza', '$turfiltradaZaraza', '$colorcrudaZaraza', '$colorfiltradaZaraza', '$phcrudaZaraza', '$phfiltradaZaraza', true)");

				if(pg_query($sqlZaraza)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Zaraza!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
    		...
    		$sqlZaraza = ("INSERT INTO zaraza_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlZaraza)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto8=='No Reportó') {
	    ...
	    if (empty($phfiltradaSocorro)) {
    		$phfiltradaSocorro = 0;
    			...
    			$sqlSocorro = ("INSERT INTO socorro_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSocorro', '$turcrudaSocorro', '$turfiltradaSocorro', '$colorcrudaSocorro', '$colorfiltradaSocorro', '$phcrudaSocorro', '$phfiltradaSocorro', true)");

				if(pg_query($sqlSocorro)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro El Socorro!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    	    
	    
    }else{
    		$sqlSocorro = ("INSERT INTO socorro_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSocorro)){
					$contadorNoReportaron++;
				}else{
					echo "<script>alert('Error Socorro!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	}
    ...
    if ($noReporto9=='No Reportó') {
	    ...
	    if (empty($phfiltradaSantaMaria)) {
    		$phfiltradaSantaMaria = 0;
    			...
    			$sqlSantaMaria = ("INSERT INTO santa_maria_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSantaMaria', '$turcrudaSantaMaria', '$turfiltradaSantaMaria', '$colorcrudaSantaMaria', '$colorfiltradaSantaMaria', '$phcrudaSantaMaria', '$phfiltradaSantaMaria', true)");

				if(pg_query($sqlSantaMaria)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Santa Maria!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlSantaMaria = ("INSERT INTO santa_maria_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSantaMaria)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto10=='No Reportó') {
	    ...
	    if (empty($phfiltradaEspino)) {
    		$phfiltradaEspino = 0;
    			...
    			$sqlEspino = ("INSERT INTO espino_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroEspino', '$turcrudaEspino', '$turfiltradaEspino', '$colorcrudaEspino', '$colorfiltradaEspino', '$phcrudaEspino', '$phfiltradaEspino', true)");

				if(pg_query($sqlEspino)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Espino!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlEspino = ("INSERT INTO espino_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlEspino)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto11=='No Reportó') {
	    ...
	    if (empty($phfiltradaGuardatinajas)) {
    		$phfiltradaGuardatinajas = 0;
	    		...
	    		$sqlGuardatinajas = ("INSERT INTO guardatinajas_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroGuardatinajas', '$turcrudaGuardatinajas', '$turfiltradaGuardatinajas', '$colorcrudaGuardatinajas', '$colorfiltradaGuardatinajas', '$phcrudaGuardatinajas', '$phfiltradaGuardatinajas', true)");

				if(pg_query($sqlGuardatinajas)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Guardatinajas!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlGuardatinajas = ("INSERT INTO guardatinajas_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlGuardatinajas)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto12=='No Reportó') {
	    ...
	    if (empty($phfiltradaSanRafael)) {
    		$phfiltradaSanRafael = 0;
	   			...
	   			$sqlSanRafael = ("INSERT INTO san_rafael_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSanRafael', '$turcrudaSanRafael', '$turfiltradaSanRafael', '$colorcrudaSanRafael', '$colorfiltradaSanRafael', '$phcrudaSanRafael', '$phfiltradaSanRafael', true)");

				if(pg_query($sqlSanRafael)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro San Rafael de Laya!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlSanRafael = ("INSERT INTO san_rafael_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSanRafael)){
					$contadorNoReportaron++;
				}else{
					echo "<script>alert('Error San Rafael de Laya!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
    ...
    if ($noReporto13=='No Reportó') {
	    ...
	    if (empty($phfiltradaChaguaramas)) {
    		$phfiltradaChaguaramas = 0;
	    		...
	    		$sqlChaguaramas = ("INSERT INTO chaguaramas_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroChaguaramas', '$turcrudaChaguaramas', '$turfiltradaChaguaramas', '$colorcrudaChaguaramas', '$colorfiltradaChaguaramas', '$phcrudaChaguaramas', '$phfiltradaChaguaramas', true)");

				if(pg_query($sqlChaguaramas)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Chaguaramas!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
	    
    }else{
    		$sqlChaguaramas = ("INSERT INTO chaguaramas_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlChaguaramas)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto14=='No Reportó') {
	    ...
	    if (empty($phfiltradaSomGaleria)) {
    		$phfiltradaSomGaleria = 0;
    			...
    			$sqlSomGaleria = ("INSERT INTO som_galeria_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSomGaleria', '$turcrudaSomGaleria', '$turfiltradaSomGaleria', '$colorcrudaSomGaleria', '$colorfiltradaSomGaleria', '$phcrudaSomGaleria', '$phfiltradaSomGaleria', true)");

				if(pg_query($sqlSomGaleria)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Sombrero Galeria!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
    		...
    		$sqlSomGaleria = ("INSERT INTO som_galeria_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSomGaleria)){
					$contadorNoReportaron++;
				}else{
    ...
    if ($noReporto15=='No Reportó') {
	    ...
	    if (empty($phfiltradaSomObrero)) {
    		$phfiltradaSomObrero = 0;
	   			 ...
	   			 $sqlSomObrero = ("INSERT INTO som_obrero_parametros (id_empleado, fecha, cloro, turcruda, turfiltrada, colorcruda, colorfiltrada, phcruda, phfiltrada, reporte) VALUES ('$idUsuario', '$fecha', '$cloroSomObrero', '$turcrudaSomObrero', '$turfiltradaSomObrero', '$colorcrudaSomObrero', '$colorfiltradaSomObrero', '$phcrudaSomObrero', '$phfiltradaSomObrero', true)");

				if(pg_query($sqlSomObrero)){
					$contadorReportaron++;
				}else{
					echo "<script>alert('No Registro Sombrero Obrero!') </script>";
					echo "<meta http-equiv='refresh' content='0,url=home.php'>";
				}
	    
    }else{
    		$sqlSomObrero = ("INSERT INTO som_obrero_parametros (id_empleado, fecha, reporte) VALUES ('$idUsuario', '$fecha', false)");
    		if(pg_query($sqlSomObrero)){
					$contadorNoReportaron++;
				}else{
...
/*
  	...
  	if ($contadorReportaron + $contadorNoReportaron == 15) {
  		echo "<script>alert('Bien, se mandaron Reportados y No reportados a la base de datos') </script>";
  		echo "<meta http-equiv='refresh' content='0,url=home.php'>";
  	}else{
